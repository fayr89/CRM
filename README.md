...
- **Современный фронт на Next.js 16** — отдельная ветка [`v0/crm-direct-sales-b863f241`](https://github.com/fayr89/CRM/tree/v0/crm-direct-sales-b863f241), разворачивается как отдельный Vercel-проект. См. [DEPLOY.md](https://github.com/fayr89/CRM/blob/v0/crm-direct-sales-b863f241/DEPLOY.md) на той ветке.
