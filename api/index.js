...
// TEMP: daily AI diag endpoint 2026-06-11-v2 (remove after use)
const _DIAG_SECRET = 'nP9xK2wM7vQ';
const _DIAG_BASE = '/api/diag/2026-06-11-v2';
async function _handleDiag(req, res) {
  ...
  if (action === 'patch_proposal') {
    ...
    const sets = ['status=$2','updated_at=NOW()']; const vals = [id, decision];
