...
// TEMP: daily AI diag endpoint 2026-06-11-v1 (remove after use)
const _DIAG_SECRET = 'qR8mT3wK5nZ';
const _DIAG_BASE = '/api/diag/2026-06-11-v1';
...
export default async function handler(req, res) {
  ...
  // TEMP diag intercept 2026-06-11-v1
