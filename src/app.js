...
import diagDailyB4gc05Routes from './routes/diagDailyB4gc05.js'; // TEMP 2026-06-18 b4gc05
...
export function createApp({ serveStatic = true } = {}) {
  ...
  app.use('/api/diag/daily-b4gc05', diagDailyB4gc05Routes); // TEMP 2026-06-18 b4gc05
  app.use((req, res) => {
