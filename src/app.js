...
import diagDailyRunRoutes from './routes/diagDailyRun.js'; // TEMP — удалить после использования
...
export function createApp({ serveStatic = true } = {}) {
  ...
  app.use('/api/diag/daily-run', diagDailyRunRoutes); // TEMP — удалить после использования
