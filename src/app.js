...
import diagDailyRoutes from './routes/diagDaily.js'; // TEMP: снести после обхода v711
...
export function createApp({ serveStatic = true } = {}) {
  ...
  app.use('/api/diag/daily-v711', diagDailyRoutes); // TEMP: снести после обхода v711
  app.use((req, res) => {
