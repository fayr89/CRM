...
import diagAiDailyRoutes from './routes/diagAiDaily.js'; // TEMP ai-daily 2026-06-22-v14
...
export function createApp({ serveStatic = true } = {}) {
  ...
  app.use('/api/diag/ai-daily', diagAiDailyRoutes); // TEMP ai-daily 2026-06-22-v14
  app.use((req, res) => {
