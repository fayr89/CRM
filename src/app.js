...
import diagAiDailyRoutes from './routes/diagAiDaily.js'; // TEMP daily run 2026-06-10-v12
...
export function createApp({ serveStatic = true } = {}) {
  ...
  app.use('/api/diag/ai-daily', diagAiDailyRoutes); // TEMP daily run 2026-06-10-v12
  app.use((req, res) => {
