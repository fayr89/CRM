...
import diagAiDailyRoutes from './routes/diagAiDaily.js'; // TEMP daily run 2026-06-10-v15
...
export function createApp({ serveStatic = true } = {}) {
  ...
  app.use('/api/diag/ai-daily', diagAiDailyRoutes); // TEMP daily run 2026-06-10-v15
  app.use((req, res) => {
