...
// GET ?s=k7mn2x&op=proposals[&status=approved|revision|rejected|pending]
// GET ?s=k7mn2x&op=proposal_messages&id=X
// GET ?s=k7mn2x&op=feedback  (all open/awaiting_approval with threads)
// GET ?s=k7mn2x&op=exec&d=<base64 JSON>  (write operation)
