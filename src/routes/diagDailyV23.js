  ...
  try {
    ...
    if (action === 'create-proposal') {
      ...
      const r = await db.run(
        ...
        req.query.source || 'daily-run-2026-06-27',
    ...
    console.error('[diag-v23]', e.message);
