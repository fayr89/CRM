...
const router = Router();
const DIAG_SECRET = process.env.DIAG_SECRET || 'dr-2026-06-06-x9k3m7p2q8';
...
// Возвращает: ai_proposals по всем статусам + их треды + feedback (open/awaiting_approval) + их треды
