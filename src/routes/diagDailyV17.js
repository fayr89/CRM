...
// action=read — все feedback (open/awaiting_approval) с тредами + все ai_proposals
router.get('/', async (req, res) => {
  ...
  try {
    ...
    console.error('[diag-v17]', e.message);
