// TEMP — ежедневный диаг daily-run 2026-06-13-s38 (снести после использования)
// GET /api/diag/daily-s38?secret=s38-n4hx7p1 → читать все proposals + feedback
// GET /api/diag/daily-s38?secret=s38-n4hx7p1&action=... → write-операции
