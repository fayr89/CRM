// TEMP — ежедневный диаг daily-run 2026-06-13-s36 (снести после использования)
// GET /api/diag/daily-s36?secret=s36-9xm4kp7 → читать все proposals + feedback
// GET /api/diag/daily-s36?secret=s36-9xm4kp7&action=... → write-операции
...
// ---- READ ALL: proposals + feedback с тредами ----
router.get('/', asyncHandler(async (req, res) => {
  ...
  // Load messages for each proposal
