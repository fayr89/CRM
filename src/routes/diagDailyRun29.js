// TEMP: ежедневный AI-обход 2026-06-10-v29. Удалить сразу после использования.
import { Router } from 'express';
import { db } from '../db.js';

const router = Router();
const SECRET = 'dr29-7xk2-2026-06-10';
...
// GET /api/diag/daily-run-29?secret=X  → всё нужное для обхода
...
// POST /api/diag/daily-run-29?secret=X  { op, ...payload }
