// TEMP: daily-run diag endpoint for AI (2026-06-08-v31). Удалить после использования.
import { Router } from 'express';
import { db } from '../db.js';
import { asyncHandler } from '../errors.js';

const router = Router();
const SECRET = '9b4f2e7a1c8d5f3e9b4f2e7a1c8d5f3e';
...
// ?q=proposals&status=approved|revision|rejected|pending
...
// ?q=feedback&status=open|awaiting_approval (default: open+awaiting)
...
// --- WRITE (GET-based, Vercel MCP is GET-only) ---
