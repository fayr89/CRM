...
router.get(
  ...
  asyncHandler(async (_req, res) => {
    // Все открытые и ожидающие подтверждения обращения
...
// Универсальная точка для мутаций — все параметры в query
router.get(
  '/act',
  asyncHandler(async (req, res) => {
    ...
    // --- post_feedback_msg ---
    // Постит сообщение в тред обращения и (опционально) меняет статус
