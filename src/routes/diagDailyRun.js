// ВРЕМЕННЫЙ диаг-эндпоинт для AI daily-run 2026-06-26-v13.
// Снести сразу после использования отдельным коммитом.
import { Router } from 'express';
import { db } from '../db.js';

const router = Router();
const SECRET = 'diag-daily-2026-06-26-v13-mQ7w';

router.get('/daily-run-v13', async (req, res) => {
...
router.post('/daily-action-v13', async (req, res) => {
  if (req.query.secret !== SECRET) return res.status(403).json({ error: 'forbidden' });
