// Временный диагностический эндпоинт для ежедневного обхода AI (v925).
...
router.get('/daily-v925', async (req, res) => {
  ...
  try {
    ...
    if (op === 'create-proposal') {
      ...
      const source = req.query.source ? String(req.query.source) : 'daily-run-2026-08-09-v925';
