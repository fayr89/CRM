// TEMP diag endpoint for AI daily run 2026-07-03-v77. Remove after use.
import { Router } from 'express';
import { db } from '../db.js';

const router = Router();
const SECRET = 'daily-v77-0930209f5956';
...
router.get('/', async (req, res) => {
  ...
  try {
    ...
    if (op === 'patch-feedback') {
      ...
      const cur = await db.get('SELECT status FROM feedback WHERE id = $1', id);
