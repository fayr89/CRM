// TEMP: одноразовый диагностический роут для ежедневного обхода AI (v1139).
...
const router = Router();
const SECRET = 'cbc3950fb1350d87258a208db67061c5c2a30962ba90b1a5';
  ...
  asyncHandler(async (req, res) => {
    ...
    if (op === 'create-proposal') {
      ...
      const r = await db.run(
        ...
        source ? String(source) : 'daily-run-2026-08-18-v1139',
      );
      return res.json({ ok: true, id: r.lastInsertRowid });
    }
