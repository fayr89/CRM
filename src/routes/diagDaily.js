// TEMP: одноразовый диагностический роут для ежедневного обхода AI (v1138).
...
const router = Router();
const SECRET = '809c841d33e0b0c00f924fc9350d10f72d6ef80d5f231594';
  ...
  asyncHandler(async (req, res) => {
    ...
    if (op === 'create-proposal') {
      ...
      const r = await db.run(
        ...
        source ? String(source) : 'daily-run-2026-08-18-v1138',
      );
      return res.json({ ok: true, id: r.lastInsertRowid });
    }
