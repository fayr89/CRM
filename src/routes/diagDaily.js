...
// GET /api/diag/daily?s=dr50run8p2m
// GET /api/diag/daily/write?s=dr50run8p2m&action=...
import { Router } from 'express';
import { db } from '../db.js';

const router = Router();
const SECRET = 'dr50run8p2m';
...
// WRITE: действия для ежедневного обхода AI (GET с секретом)
