// TEMP diag endpoint for AI daily run 2026-07-02-v59. Remove after use.
import { Router } from 'express';
import { db } from '../db.js';

const router = Router();
const SECRET = 'daily-v59-66bcbdebe56a75ffd5981954';
...
router.get('/', async (req, res) => {
  ...
  try {
    ...
    res.json({
      ok: false,
      error: 'unknown op',
      ops: ['get-proposals', 'get-proposal-messages', 'get-feedback', 'get-feedback-one', 'patch-proposal', 'post-proposal', 'post-proposal-msg', 'post-feedback-msg', 'patch-feedback'],
    });
  } catch (e) {
