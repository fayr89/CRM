// TEMP: одноразовый диагностический роут для ежедневного обхода AI (v1134).
...
const router = Router();
const SECRET = 'af1b2ba5886d1a450208bca0e4ff4c08d5f47a14a824c7ec';
  ...
  asyncHandler(async (req, res) => {
    ...
    if (op === 'create-proposal') {
      ...
      const r = await db.run(
        ...
        source ? String(source) : 'daily-run-2026-08-18-v1134',
      );
      return res.json({ ok: true, id: r.lastInsertRowid });
    }
