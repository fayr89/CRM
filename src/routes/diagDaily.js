// Временный диагностический эндпоинт для ежедневного обхода AI (v1261).
...
const router = Router();
const SECRET = 'v1261-2955ef3bc44ca2bde7736e812fbe2741';

router.get('/daily-v1261', async (req, res) => {
