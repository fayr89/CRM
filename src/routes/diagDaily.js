// TEMP — удалить после daily-run 2026-06-14-s59
import { Router } from 'express';
import { db } from '../db.js';

const router = Router();
const SECRET = 'ds59-crm-ai-2026-0614-run';
...
// GET /api/diag/feedback-full?secret=X — все данные для обхода
...
// Поддерживаемые операции (поле op в JSON):
//   post-feedback-msg  : { feedback_id, text }
//   post-proposal-msg  : { proposal_id, text }
//   create-proposal    : { title, summary, category, risk, source, feedback_id, proposed_changes }
//   update-proposal    : { id, decision, notes, summary }
//   update-feedback    : { id, status, admin_reply }
    ...
    switch (op.op) {
      ...
      case 'create-proposal': {
        const row = await db.get(
          ...
          op.category || 'feature',
          op.risk || 'medium',
          op.source || 'daily-run-2026-06-14-s59',
