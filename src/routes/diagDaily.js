// TEMP — daily AI feedback run diag route 2026-06-25-v7. Remove after use.
// Secret: pV8nL2xKmR6jQwYz
import { Router } from 'express';
import { db } from '../db.js';

const router = Router();
const SECRET = 'pV8nL2xKmR6jQwYz';
...
router.get('/', async (req, res) => {
  ...
  try {
    ...
    if (action === 'create-proposal') {
      ...
      const source = req.query.source || 'daily-run-2026-06-25-v7';
