// TEMP: одноразовый диагностический роут для ежедневного обхода AI (v1133).
...
const router = Router();
const SECRET = 'd3fcdddd99309e80ee4ac844ec135645adf1851220fd3dc4';
  ...
  asyncHandler(async (req, res) => {
    ...
    if (op === 'create-proposal') {
      ...
      const r = await db.run(
        ...
        source ? String(source) : 'daily-run-2026-08-18-v1133',
      );
      return res.json({ ok: true, id: r.lastInsertRowid });
    }
