// TEMP: одноразовый диагностический роут для ежедневного обхода AI (v1135).
...
const router = Router();
const SECRET = '9c418f37f1cb32f97e5c3f34a1023b232520a3e10e344b47';
  ...
  asyncHandler(async (req, res) => {
    ...
    if (op === 'create-proposal') {
      ...
      const r = await db.run(
        ...
        source ? String(source) : 'daily-run-2026-08-18-v1135',
      );
      return res.json({ ok: true, id: r.lastInsertRowid });
    }
