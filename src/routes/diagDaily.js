// TEMP: одноразовый диагностический роут для ежедневного обхода AI (v1145).
...
const router = Router();
const SECRET = 'v1145_6ee20bcd84774fafdc28412d48bd3b74a249c46a';
  ...
  asyncHandler(async (req, res) => {
    ...
    if (op === 'create-proposal') {
      ...
      const r = await db.run(
        ...
        source ? String(source) : 'daily-run-2026-08-19-v1145',
      );
      return res.json({ ok: true, id: r.lastInsertRowid });
    }
