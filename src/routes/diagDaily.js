// Временный диагностический эндпоинт для ежедневного обхода AI (v966).
...
router.get('/daily-v966', async (req, res) => {
  ...
  try {
    ...
    if (op === 'create-proposal') {
      ...
      const source = req.query.source ? String(req.query.source) : 'daily-run-2026-08-11-v966';
