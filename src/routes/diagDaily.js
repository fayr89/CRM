...
// Секрет: kgk84ztkho7h (одноразовый, не использовать повторно).
import { Router } from 'express';
import { db } from '../db.js';

const SECRET = 'kgk84ztkho7h';
const router = Router();

// GET /api/diag/daily-kgk84ztkho7h?s=SECRET          — читает все данные
// GET /api/diag/daily-kgk84ztkho7h?s=SECRET&payload=BASE64_JSON — выполняет действия
// payload — base64(JSON): [{action, ...params}] или один объект {action, ...params}
router.get('/daily-kgk84ztkho7h', async (req, res) => {
