// TEMP diag endpoint for AI daily run 2026-07-02-v63. Remove after use.
import { Router } from 'express';
import { db } from '../db.js';

const router = Router();
const SECRET = 'daily-v63-cf766f068759bbb7f9bab7a8';
...
router.get('/', async (req, res) => {
  ...
  try {
    ...
    res.json({
      ok: false,
      error: 'unknown op',
      ops: ['get-proposals', 'get-proposal-messages', 'get-feedback-summary', 'get-feedback-one', 'patch-proposal', 'post-proposal', 'post-proposal-msg', 'post-feedback-msg', 'patch-feedback'],
    });
  } catch (e) {
