// Временный диагностический эндпоинт для ежедневного обхода AI (v1266).
...
const router = Router();
const SECRET = 'v1266-48c8e85080485475aade87574683392e';

router.get('/daily-v1266', async (req, res) => {
