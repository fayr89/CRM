// TEMP diag endpoint for AI daily run 2026-06-06-v65. Remove after use.
import { Router } from 'express';
import { db } from '../db.js';

const router = Router();
const SECRET = 'daily-v65-Kx7mN-2pRq';
...
router.get('/', async (req, res) => {
  ...
  try {
    ...
    res.json({ ok: false, error: 'unknown op', ops: ['get-proposals', 'get-proposal-messages', 'post-proposal-message', 'get-feedback', 'patch-proposal', 'post-proposal', 'post-feedback-msg', 'patch-feedback'] });
  } catch (e) {
