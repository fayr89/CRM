// TEMP diag endpoint for AI daily run 2026-07-04-v102. Remove after use.
import { Router } from 'express';
import { db } from '../db.js';

const router = Router();
const SECRET = 'daily-v102-5a2296e5537a22f83aaa4078';
...
router.get('/', async (req, res) => {
  ...
  try {
    ...
    if (op === 'branch-count') {
      return res.json({ ok: true, data: 'n/a - use GitHub API' });
    }
