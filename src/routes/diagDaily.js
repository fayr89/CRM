// Временный диагностический эндпоинт для ежедневного обхода AI (v970).
...
router.get('/daily-v970', async (req, res) => {
  ...
  try {
    ...
    if (op === 'create-proposal') {
      ...
      const source = req.query.source ? String(req.query.source) : 'daily-run-2026-08-11-v970';
