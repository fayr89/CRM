// TEMP diag endpoint for AI daily run 2026-07-04-v106. Remove after use.
import { Router } from 'express';
import { db } from '../db.js';

const router = Router();
const SECRET = '52520882c28b0bda8a16b580f04281b4';
...
router.get('/', async (req, res) => {
  ...
  try {
    ...
    if (op === 'count-orphan-branches') {
      return res.json({ ok: true, note: 'not supported here, use github API' });
    }
