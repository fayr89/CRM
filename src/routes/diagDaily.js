// TEMP: одноразовый диагностический роут для ежедневного обхода AI (v1137).
...
const router = Router();
const SECRET = 'd8374e2cb7835c829b9a8383e4a017952a272ac25eaca5d2';
  ...
  asyncHandler(async (req, res) => {
    ...
    if (op === 'create-proposal') {
      ...
      const r = await db.run(
        ...
        source ? String(source) : 'daily-run-2026-08-18-v1137',
      );
      return res.json({ ok: true, id: r.lastInsertRowid });
    }
