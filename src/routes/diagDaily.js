// TEMP — daily AI feedback run diag route 2026-06-25-v8. Remove after use.
// Secret: nZ5qR3wKpJ7xMvTb
import { Router } from 'express';
import { db } from '../db.js';

const router = Router();
const SECRET = 'nZ5qR3wKpJ7xMvTb';
...
router.get('/', async (req, res) => {
  ...
  try {
    ...
    if (action === 'create-proposal') {
      ...
      const source = req.query.source || 'daily-run-2026-06-25-v8';
