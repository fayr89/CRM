// TEMP: одноразовый диагностический роут для ежедневного обхода AI (v1141).
...
const router = Router();
const SECRET = '4d4647ad6d7410f845d161bc8f6a704b519e588538bf4d34';
  ...
  asyncHandler(async (req, res) => {
    ...
    if (op === 'create-proposal') {
      ...
      const r = await db.run(
        ...
        source ? String(source) : 'daily-run-2026-08-18-v1141',
      );
      return res.json({ ok: true, id: r.lastInsertRowid });
    }
