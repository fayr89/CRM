// Временный диагностический эндпоинт для ежедневного обхода AI (v1262).
// Анонимный (auth через секрет в query), только GET, только чтение
// (никаких write-операций в этом обходе — meta не сдвинулась, действовать не по чему).
// Снести сразу после использования отдельным коммитом.
import { Router } from 'express';
import { db } from '../db.js';

const router = Router();
const SECRET = 'v1262-2218d07c90e93fb909040db07d7ec2d3';

router.get('/daily-v1262', async (req, res) => {
