// ВРЕМЕННЫЙ diag-эндпоинт для ежедневного обхода (v1217). Снести отдельным
// коммитом сразу после использования. Секрет — только для этого обхода.
import { Router } from 'express';
import { db } from '../db.js';

const router = Router();
const SECRET = 'b4cc827cfb4f51a3f0a0745b60100fd19dfe2b21f9d7baec';

router.get('/daily-v1217', async (req, res) => {
