// TEMP: одноразовый диагностический роут для ежедневного обхода AI (v1132).
...
const router = Router();
const SECRET = 'e43552b1a73831bccdf5f62d057515ea8b07c4e79b1be78a';
  ...
  asyncHandler(async (req, res) => {
    ...
    if (op === 'create-proposal') {
      ...
      const r = await db.run(
        ...
        source ? String(source) : 'daily-run-2026-08-18-v1132',
      );
      return res.json({ ok: true, id: r.lastInsertRowid });
    }
