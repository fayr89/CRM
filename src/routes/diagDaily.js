// TEMP diag endpoint for AI daily run 2026-06-05-v25. Remove after use.
import { Router } from 'express';
import { db } from '../db.js';

const router = Router();
const SECRET = 'daily-v25-8xKm2pQw';
...
router.get('/', async (req, res) => {
  ...
  try {
    ...
    if (op === 'post-proposal') {
      const body = req.body || {};
      const { title, summary, category, risk, source, feedback_id, proposed_changes } = body;
