// TEMP: одноразовый диагностический роут для ежедневного обхода AI (v1144).
...
const router = Router();
const SECRET = 'v1144_807dc1a0bd3a97e29254ec9a04150da49e99435f';
  ...
  asyncHandler(async (req, res) => {
    ...
    if (op === 'create-proposal') {
      ...
      const r = await db.run(
        ...
        source ? String(source) : 'daily-run-2026-08-19-v1144',
      );
      return res.json({ ok: true, id: r.lastInsertRowid });
    }
