// TEMP: одноразовый диагностический роут для ежедневного обхода AI (v1143).
...
const router = Router();
const SECRET = 'v1143_6c7f2c364e02feb7e6cf70b4d9f5db0bf7749805';
  ...
  asyncHandler(async (req, res) => {
    ...
    if (op === 'create-proposal') {
      ...
      const r = await db.run(
        ...
        source ? String(source) : 'daily-run-2026-08-18-v1143',
      );
      return res.json({ ok: true, id: r.lastInsertRowid });
    }
