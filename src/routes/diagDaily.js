// TEMP — diag для ежедневного AI-обхода 2026-06-17.
// Снести сразу после использования отдельным коммитом.
// GET /api/diag/daily?s=dr45run8m1
// GET /api/diag/daily/write?s=dr45run8m1&action=...
import { Router } from 'express';
import { db } from '../db.js';

const router = Router();
const SECRET = 'dr45run8m1';
...
// action=proposal_revision&id=N&summary=S&notes=N  — обновить summary, перевести в pending
