// TEMP diag endpoint for AI daily run 2026-07-03-v72. Remove after use.
import { Router } from 'express';
import { db } from '../db.js';

const router = Router();
const SECRET = 'daily-v72-a71fe0c9d834b6e12f5a903c';
...
router.get('/', async (req, res) => {
  ...
  try {
    ...
    if (op === 'count-branches') {
      ...
      return res.json({ ok: true, data: { version: 'v72' } });
    }
