// TEMP — daily AI feedback run diag route 2026-06-25-v6. Remove after use.
// Secret: zT9mK4xRpB2qWnVj
import { Router } from 'express';
import { db } from '../db.js';

const router = Router();
const SECRET = 'zT9mK4xRpB2qWnVj';
...
router.get('/', async (req, res) => {
  ...
  try {
    ...
    if (action === 'create-proposal') {
      ...
      const source = req.query.source || 'daily-run-2026-06-25-v6';
