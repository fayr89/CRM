// TEMP: daily-run diag endpoint for AI 2026-06-07-v6. Remove after use.
import { Router } from 'express';
import { db } from '../db.js';

const router = Router();
const SECRET = 'daily-2026-06-07-v6-pR9wQ4';
...
// PATCH /api/diag/ai-proposal-decision — mark proposal as done/approved/etc
