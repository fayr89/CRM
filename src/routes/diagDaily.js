// TEMP diag endpoint for AI daily run 2026-07-01-v39. Remove after use.
import { Router } from 'express';
import { db } from '../db.js';

const router = Router();
const SECRET = 'daily-v39-7f2ac913de6b40a1b5f9e2c0';
...
router.get('/', async (req, res) => {
  ...
  try {
    ...
    // ------- READ: recent AI daily audit log entries (to detect scheduling issues) -------
    if (op === 'get-audit') {
    ...
    res.json({
      ok: false,
      error: 'unknown op',
      ops: ['get-proposals', 'get-proposal-messages', 'get-feedback', 'get-audit', 'patch-proposal', 'post-proposal', 'post-proposal-msg', 'post-feedback-msg', 'patch-feedback'],
    });
  } catch (err) {
