// Временный диагностический эндпоинт для ежедневного обхода AI (v1265).
...
const router = Router();
const SECRET = 'v1265-7c4a1f93e5b28d06a4f7c1b9e3d582a4';

router.get('/daily-v1265', async (req, res) => {
