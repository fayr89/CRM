// TEMP: одноразовый диагностический роут для ежедневного обхода AI (v1136).
...
const router = Router();
const SECRET = '3d497fb054db4dc1f4fd896b511c39a420248663b7e688bd';
  ...
  asyncHandler(async (req, res) => {
    ...
    if (op === 'create-proposal') {
      ...
      const r = await db.run(
        ...
        source ? String(source) : 'daily-run-2026-08-18-v1136',
      );
      return res.json({ ok: true, id: r.lastInsertRowid });
    }
