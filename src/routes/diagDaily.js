// TEMP — daily AI feedback run diag route 2026-06-25-v5. Remove after use.
// Secret: pK3nZ8xQwT6yRmBv
import { Router } from 'express';
import { db } from '../db.js';

const router = Router();
const SECRET = 'pK3nZ8xQwT6yRmBv';
...
router.get('/', async (req, res) => {
  ...
  try {
    ...
    if (action === 'create-proposal') {
      ...
      const source = req.query.source || 'daily-run-2026-06-25-v5';
