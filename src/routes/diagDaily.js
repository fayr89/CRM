// Временный диагностический эндпоинт для ежедневного обхода AI (v1346).
// Анонимный (auth через секрет в query), только GET. Снести сразу после использования.
import { Router } from 'express';
import { db } from '../db.js';

const router = Router();
const SECRET = 'v1346-7c19af0e33d8b6a41f5c';

router.get('/daily-v1346', async (req, res) => {
