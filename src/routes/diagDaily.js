// Временный диагностический эндпоинт для ежедневного обхода AI (v1105).
...
router.get('/daily-v1105', async (req, res) => {
  ...
  try {
    ...
    if (op === 'create-proposal') {
      ...
      const source = req.query.source ? String(req.query.source) : 'daily-run-2026-08-17-v1105';
