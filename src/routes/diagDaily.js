// TEMP: одноразовый диагностический роут для ежедневного обхода AI (v1131).
...
const router = Router();
const SECRET = '426d68d8c70b2dc13a1b69db88d6042322ee0c42ebfe7444';
  ...
  asyncHandler(async (req, res) => {
    ...
    if (op === 'create-proposal') {
      ...
      const r = await db.run(
        ...
        source ? String(source) : 'daily-run-2026-08-18',
      );
      return res.json({ ok: true, id: r.lastInsertRowid });
    }
