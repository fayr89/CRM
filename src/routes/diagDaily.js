// Временный диагностический эндпоинт для ежедневного обхода AI (v1206).
// Анонимный (auth через секрет в query), только GET (op=post-* делает POST во внутренние
// таблицы через db, не HTTP-POST — секрет тот же). Снести сразу после использования.
import { Router } from 'express';
import { db } from '../db.js';

const router = Router();
const SECRET = 'v1206-9c17e4a2f6b0d385';

router.get('/daily-v1206', async (req, res) => {
