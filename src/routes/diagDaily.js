// TEMP: одноразовый диагностический роут для ежедневного обхода AI (v1140).
...
const router = Router();
const SECRET = '655d980c1704bf4faa599c7ec269c12686e13b9fef24442e';
  ...
  asyncHandler(async (req, res) => {
    ...
    if (op === 'create-proposal') {
      ...
      const r = await db.run(
        ...
        source ? String(source) : 'daily-run-2026-08-18-v1140',
      );
      return res.json({ ok: true, id: r.lastInsertRowid });
    }
