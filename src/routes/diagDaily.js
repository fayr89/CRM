// Временный диагностический эндпоинт для ежедневного обхода AI (v1263).
...
const router = Router();
const SECRET = 'v1263-7f3a9c1e5b4d8062a4c9d0f1e2b3a678';

router.get('/daily-v1263', async (req, res) => {
