// TEMP diag endpoint for AI daily run 2026-07-03-v70. Remove after use.
import { Router } from 'express';
import { db } from '../db.js';

const router = Router();
const SECRET = 'daily-v70-a27cf47f1500819bcb44e7cb';
...
router.get('/', async (req, res) => {
  ...
  try {
    ...
    return res.json({ ok: false, error: `unknown op: ${op}` });
  } catch (e) {
