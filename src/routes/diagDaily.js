...
// Session: FyQD0 / 2026-06-03-v3
import { Router } from 'express';
import { db } from '../db.js';

const router = Router();
const SECRET = 'diag-FyQD0-2026-06-03-v3';
...
// GET /api/diag/daily?secret=X&op=post-message&feedback_id=N&text=...
// POST message as AI ассистент
  ...
  try {
    ...
    if (op === 'create-proposal') {
      ...
      const r = await db.run(
        ...
        category || null,
        risk || 'medium',
        source || 'daily-run-2026-06-03-v3',
